...
/// entidade de negócio ainda (TodoTask é BE-05), então o CRUD trivial que
/// exercita CA-05/CA-06/CA-07 precisa de uma. Vive só neste projeto de teste
/// — nunca em produção — mas implementa as mesmas interfaces de domínio
/// (<see cref="IAuditable"/>, <see cref="ISoftDeletable"/>) que uma entidade
/// real do Tasks vai implementar a partir de BE-05.
/// </summary>
