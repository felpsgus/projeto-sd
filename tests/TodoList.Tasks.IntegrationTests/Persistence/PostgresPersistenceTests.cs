...
/// <see cref="PostgresCollectionDefinition"/>) — evita o custo de subir um
/// container por teste sem deixar estado vazar de um teste para o outro.
/// </para>
/// </summary>
[Collection("Postgres")]
public class PostgresPersistenceTests : IAsyncLifetime
{
    ...
    {
        // Ordem obrigatória (README, nota técnica de BE-02): a migration do
        // Tasks que cria a FK cruzada (CA-02c) referencia identity.users —
        // sem migrar o Identity primeiro, o Postgres rejeita a FK por falta
    ...
    private TasksDbContext CreateTasksContext()
    {
        var options = new DbContextOptionsBuilder<TasksDbContext>()
            ...
            // BE-05: com TodoTask mapeada, o modelo passou a ter nomes de
            // coluna reais — sem a mesma convenção usada em runtime e no
            // design-time factory, o EF acusa "pending model changes" ao
            // migrar (o hash do modelo não bate com o snapshot).
