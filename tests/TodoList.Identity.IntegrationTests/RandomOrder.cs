...
[assembly: TestCaseOrderer(
    "TodoList.Identity.IntegrationTests.RandomTestCaseOrderer",
    "TodoList.Identity.IntegrationTests")]
[assembly: TestCollectionOrderer(
    "TodoList.Identity.IntegrationTests.RandomTestCollectionOrderer",
    "TodoList.Identity.IntegrationTests")]
...
internal static class RandomOrderSeed
{
    ...
    private static int ResolveSeed()
    {
        ...
        Console.WriteLine(
            $"[TodoList.Identity.IntegrationTests] ordem dos testes aleatória, semente {seed} "
